...
export const LeaderChatView: React.FC = () => {
        ...
        <div className="h-16 px-4 sm:px-6 border-b border-slate-100 flex items-center justify-between bg-white shrink-0">
          <div className="flex items-center gap-3">
            ...
            {activeRecipient ? (
              ...
              <div className="w-9 h-9 rounded-xl bg-purple-100 text-purple-700 border border-purple-200 flex items-center justify-center font-bold">
            ...
            <div>
              ...
              <p className="text-[11px] text-slate-400 font-medium truncate max-w-xs sm:max-w-md">
                {activeRecipient
                  ...
                  : `Leader Workspace Channel · ${activeProject ? activeProject.name : "All Projects Scope"}`}
              </p>
            </div>
          </div>

          <div className="hidden sm:flex items-center gap-2">
            <span className="text-xs font-black uppercase text-purple-700 bg-purple-50 px-3 py-1 rounded-full border border-purple-200 flex items-center gap-1">
              <Crown className="w-3.5 h-3.5" /> Leader Control Center
            </span>
          </div>
        </div>
