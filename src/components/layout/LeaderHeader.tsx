    ...
    <header className="h-16 shrink-0 bg-white px-8 flex items-center justify-between sticky top-0 z-20 pt-2 border-b border-slate-100 font-sans">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="relative">
          ...
          >
            <Briefcase className="w-3.5 h-3.5 text-[#006858]" />
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="hidden md:flex items-center gap-1.5 px-3 py-1 rounded-full bg-emerald-50 text-[#006858] border border-emerald-200 text-[11px] font-extrabold">
          <Crown className="w-3.5 h-3.5 text-[#006858]" />
        ...
        >
          ...
          <span className="absolute top-1.5 right-1.5 w-2 h-2 bg-[#006858] rounded-full ring-2 ring-white" />
        </button>
          ...
          {showUserMenu && (
            <div className="absolute right-0 mt-2 w-60 bg-white rounded-2xl p-2 shadow-xl border border-slate-100 z-50 animate-in fade-in slide-in-from-top-2">
              <div className="px-3 py-2 border-b border-slate-100 mb-1">
                ...
                <span className="inline-block mt-1 text-[9px] font-black uppercase bg-emerald-50 text-[#006858] px-2 py-0.5 rounded-full">
                  Leader / Admin
                </span>
              </div>
